...
Route::middleware(["auth", "nocache"])->group(function () {
    ...
    Route::get("/profile/company/requests", [CompanyRequestController::class, "index"])->name("company-requests.index");
    Route::get("/profile/company/requests/create", [CompanyRequestController::class, "create"])->name("company-requests.create");
    Route::post("/profile/company/requests", [CompanyRequestController::class, "store"])->name("company-requests.store");
    Route::get("/profile/company/requests/{id}", [CompanyRequestController::class, "show"])->name("company-requests.show");
    Route::delete("/profile/company/requests/{id}", [CompanyRequestController::class, "destroy"])->name("company-requests.destroy");
    Route::get("/profile/company/requests/create", [CompanyRequestController::class, "create"])->name("company-requests.create");
    Route::post("/profile/company/requests", [CompanyRequestController::class, "store"])->name("company-requests.store");
    Route::get("/profile/university", [AuthController::class, "universityProfile"])->name("university-profile");
...
Route::middleware(["auth", "nocache", \App\Http\Middleware\AdminMiddleware::class])->group(function () {
